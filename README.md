...
- 신고 등록, 내 신고 목록/상세
- 사용자 차단/해제, 차단 목록 조회
- 관리자 회원/상품/신고/거래/감사 로그 API
- 한국어 기반 주요 화면: 상품 목록, 로그인, 회원가입, 상품 등록, 상품 상세, 거래 목록, 채팅 목록, 관리자 화면
...
6. 관리자 계정 로그인 후 관리자 페이지와 `/docs`에서 관리 API 확인
